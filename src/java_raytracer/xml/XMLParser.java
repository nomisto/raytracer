...
import java_raytracer.scene.*;
import java_raytracer.scene.light.*;
import java_raytracer.scene.material.*;
import java_raytracer.scene.surface.*;
import java_raytracer.scene.transformation.*;
import java_raytracer.util.Vec3;
import java_raytracer.util.Vec4;

/**
 * @author Simon
 * This class parses the given XML file and produces a Scene
 */
public class XMLParser {
	
	/**
	 * @param link The link to the XML file
	 * @return A Scene object containing all of the elements of a scene (camera,...) which was parsed out of the specified xml file
	 */
